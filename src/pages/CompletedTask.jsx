...
const CompletedTasks = (props) => {
  ...
  return (
    <>
     <iframe title="dashboard" src={`${YELLOWFIN_URL}/RunDashboard.i4;?dashUUID=4fa1a74b-bfb8-42fa-9249-70d0bf4b2cc8&primaryOrg=1&clientOrg=1`} width="100%" style={{height:"50vh", marginTop: "-3rem",border: "none"}}></iframe>
      <Box sx={{ display: "flex" }}>
        <SideNav />
